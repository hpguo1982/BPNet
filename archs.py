...
class KANLayer(nn.Module):#KANbranches
...
class RegionAdaptiveKANBlock(nn.Module):#RAKB
...
class BPNet(nn.Module):
    def __init__(self, num_classes=1, input_channels=3, deep_supervision=False,
        ...
        assert num_classes == 1, "当前版本 BPNet 只实现二分类输出(num_classes=1)。"
        ...
        self.prototype_lesion = nn.Parameter(torch.randn(C_last))
